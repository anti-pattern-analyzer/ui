...
const WeightedGraphViewer = () => {
  ...
  return (
    <div className="p-6 flex space-x-6 relative">
      {/* Graph Section */}
      <div className="w-3/4 flex flex-col space-y-6">
        <h1 className="text-2xl font-bold text-gray-800">📊 Weighted Dependency Graph</h1>
      ...
      {/* Fixed Side Panel with Auto-Scrolling */}
      <div ref={sidePanelRef} className="w-1/4 bg-gray-100 p-4 rounded shadow-md fixed right-0 top-6 bottom-6 overflow-y-auto">
          ...
          {weightedGraph.nodes.map((node) => (
            <div
              ...
              className={`p-2 border rounded cursor-pointer ${
                hoverNode && hoverNode.id === node.id ? "bg-yellow-300" : "bg-white"
              }`}
            >
